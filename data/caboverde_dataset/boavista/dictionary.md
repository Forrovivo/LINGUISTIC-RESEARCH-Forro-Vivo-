# Kabuverdianu of Boa Vista dictionary
...
This file is a **Boa Vista-only** Cabo Verdean Creole dataset. It is not a website and not an application.
...
```json
{"status": "error", "code": "TERM_NOT_FOUND", "message": "Translation not available in the verified Kabuverdianu of Boa Vista database."}
```
