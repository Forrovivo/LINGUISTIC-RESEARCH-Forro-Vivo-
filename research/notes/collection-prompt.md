...
The objective is to create a reliable linguistic dataset that the ForroVivo ecosystem can consume without inventing translations.
...
This task is strictly about **linguistic data collection and dataset construction** for the ForroVivo Linguistic Research initiative.

DO NOT:

- inspect the ForroVivo website or App Store product source code
- inspect Swift files
- inspect React files
