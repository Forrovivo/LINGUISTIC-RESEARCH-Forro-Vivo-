...
This repository collects verified dictionary data for Portuguese-lexifier creoles. Accuracy comes before coverage. A missing translation is better than a guessed one.

The operational specification is [Three-Language Dictionary Data Collection Prompt.md](Three-Language%20Dictionary%20Data%20Collection%20Prompt.md). How to contribute: [CONTRIBUTING.md](CONTRIBUTING.md). Bibliography: [SOURCES.md](SOURCES.md).

This is a **data collection and linguistic research** task. Do not inspect, modify, or discuss ForroVivo application code, UI, or databases in this repository.
...
|---|---|---|---|---|
| Forro / Santome / Santomense | *lungwa santome* | cri | `dictionary/saotome/forro/` | Forro ↔ Portuguese, Forro ↔ English |
| Angolar / Ngola | *n'golá* | aoa | `dictionary/saotome/angolar/` | Angolar ↔ Portuguese, Angolar ↔ English |
| Principense / Lung’Ie | *lung’Ie* | pre | `dictionary/saotome/lungie/` | Lung’Ie ↔ Portuguese, Lung’Ie ↔ English |
| Kabuverdianu / Kriolu | island varieties | kea | `dictionary/caboverde/<island>/` | that island ↔ Portuguese, that island ↔ English |
| Kriol / Kiriol of Guinea-Bissau | regional varieties | pov | `dictionary/guinebissau/<region>/` | that region ↔ Portuguese, that region ↔ English |

`dictionary/angola/` is an alias of Angolar. Do not grow a second lexicon there.
...
Search order: provided files in this repository, then academic and institutional sources, then reliable linguistic websites. See [SOURCES.md](SOURCES.md).
...
Angolar JSON → copy into dictionary/angola/
```
