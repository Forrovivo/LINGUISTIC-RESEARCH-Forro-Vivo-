...
The service loads `data/*/dictionary.json`. It does not invent translations or merge languages. DNS for `api.forrovivo.com` must point at this process. The public brand is `www.forrovivo.com`. The language-learning product is on the App Store.
