# Kabuverdianu of Brava sources

This dataset documents **Kabuverdianu of Brava** only (Sotavento).
...
### Marlyse Baptista 2013 (APiCS Brava)

- **Author:** Marlyse Baptista
- **Year:** 2013
- **Title:** APiCS survey and structure dataset: Cape Verdean Creole of Brava
- **APiCS language ID:** 31
- **Survey URL:** https://apics-online.info/surveys/31
- **Structure dataset URL:** https://apics-online.info/contributions/31
...
```json
{
  "status": "error",
  "code": "TERM_NOT_FOUND",
  "message": "Translation not available in the verified Kabuverdianu of Brava database."
}
```
