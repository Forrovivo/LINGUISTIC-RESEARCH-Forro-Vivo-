# Kabuverdianu of Boa Vista sources

This dataset documents **Kabuverdianu of Boa Vista** only (Barlavento).

Translation pairs: Kabuverdianu of Boa Vista → Portuguese, Kabuverdianu of Boa Vista → English.
...
```json
{
  "status": "error",
  "code": "TERM_NOT_FOUND",
  "message": "Translation not available in the verified Kabuverdianu of Boa Vista database."
}
```
