# Kabuverdianu of Maio sources

This dataset documents **Kabuverdianu of Maio** only (Sotavento).

Translation pairs: Kabuverdianu of Maio → Portuguese, Kabuverdianu of Maio → English.
...
```json
{
  "status": "error",
  "code": "TERM_NOT_FOUND",
  "message": "Translation not available in the verified Kabuverdianu of Maio database."
}
```
