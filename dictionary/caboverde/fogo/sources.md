...
None yet. Add attested forms only from sources that name the Fogo variety.
...
- APiCS Online, when the survey or example is labelled as Fogo / this variety
- Published dictionaries and grammars of this island variety
- ALUPEC documents, only when they give a lemma labelled for Fogo
