...
Linguistic data only. Not a website. Not an application.
...
|---|---|---|---|
| São Tomé and Príncipe | Forro, Angolar, Lung’Ie | Country folder | [saotome/](saotome/) |
...
`dictionary/angola/` is an alias of this dataset.
...
The repository-root file `dictionary.md` is a small comparative seed. It is not a merged lexicon.
